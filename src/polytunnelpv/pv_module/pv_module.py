...
class SolarCell:
    ...
    def __str__(self):
        ...
        -------
        TYPE
            information of cell and light source .

        """
        return "%s(x_wid=%g, y_len=%g, cell_tilt=%g, cell_azi=%g, break_volt=%g) " % (
            "cell infromation: ",
            self._xwid,
            self._ylen,
            self._cell_tilt,
    ...
    def __eq__(self, other) -> bool:
        return self._cell_tilt == other._cell_tilt
    ...
    def get_cell_tilt(self):

        return self._cell_tilt
    ...
    def get_irradiance(
        self, dni=1000, dhi=46.5, ghi=200, solar_zenith=0, solar_azimuth=90
    ):
